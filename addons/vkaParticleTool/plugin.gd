...
func _enter_tree() -> void:
	...
	#add_control_to_bottom_panel(particleControlPanel, "Particle Control Panel")
	#AparticleControlPanel.editor_interface = get_editor_interface()
...
func _exit_tree() -> void:
	...
	#remove_control_from_bottom_panel(particleControlPanel)
